    ...
    def main(self) -> None:
        ...
        while True:
            ...
            if key_press:
                ...
                check = player.Player.hitbox.collidelist(self.map.collision_rects)
            ...
            pygame.draw.rect(game_settings.Game_settings.DISPLAY_SURF, (255, 0, 0), player.Player.hitbox, 2)
